...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <div class="flex rounded-lg">
                                <span class="hidden lg:inline-flex items-center px-4 rounded-l-lg border border-r-0 border-gray-300 bg-gray-50 text-gray-500 text-sm">
                        ...
                        @if (in_array($type, ['article', 'news']))
                            <div>
                                ...
                                <textarea wire:model="content" id="content" rows="15"
                                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-200 focus:border-green-500 transition-colors font-mono"></textarea>
                                @error('content')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 {{ $featured_image_url ? 'bg-gray-50' : '' }}">
                        ...
                        @if ($pdf_url)
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <p class="text-sm font-medium text-gray-900">{{ $pdf_name ?? 'Arquivo PDF' }}</p>
                                        <p class="text-xs text-gray-500">
                                            <a href="{{ $pdf_url }}" target="_blank" class="text-green-600 hover:text-green-700">
                                ...
                                <div class="space-y-2 max-h-60 overflow-y-auto p-3 border border-gray-200 rounded-lg">
                                    @foreach ($categories as $category)
                                        <div class="flex items-center">
                                            ...
                                            <label for="category_{{ $category->id }}" class="ml-3 text-sm text-gray-700">
                                                {{ $category->name }}
                                            </label>
                                        </div>
                                    @endforeach
        ...
        @if (session()->has('success'))
            <div class="mt-4 bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg flex items-center">
