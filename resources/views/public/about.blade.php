...
@section('description', 'Conheça a história, missão e valores do Espaço Islâmico - Jornal Digital dedicado à comunidade muçulmana de Moçambique e PALOP.')

@section('content')
<div class="min-h-screen bg-white">
    {{-- Hero --}}
    <div class="relative bg-gradient-to-br from-[#1a1a1a] to-[#2d2d2d] py-20 md:py-28 overflow-hidden">
        <div class="absolute top-0 right-0 w-[500px] h-[500px] bg-[#77c159] rounded-full blur-[200px] opacity-10"></div>
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center">
            <div x-data="{ show: true }" 
                ...
                <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/user_69a0952abe7cb8c0c94a27c4/13aba247d_logo.png" 
                     alt="Espaço Islâmico" 
                     class="h-24 md:h-32 mx-auto mb-6">
                <h1 class="text-4xl md:text-5xl font-bold text-white mb-4">Espaço Islâmico</h1>
    ...
    <section class="max-w-5xl mx-auto px-4 sm:px-6 py-16 md:py-20">
        <div class="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="bg-gradient-to-br from-[#77c159]/10 to-[#77c159]/5 rounded-3xl p-8 md:p-10 flex items-center justify-center">
                <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/user_69a0952abe7cb8c0c94a27c4/13aba247d_logo.png" 
                     alt="Espaço Islâmico" 
                     class="w-48 md:w-64 opacity-90">
            </div>
        </div>
    </section>
    ...
    @php
        $values = [
            [
                'icon' => 'target',
                'title' => 'Missão',
                'description' => 'Servir como ponte de informação e educação para a comunidade muçulmana de Moçambique e dos países lusófonos, promovendo o conhecimento islâmico autêntico.'
            ],
            [
                'icon' => 'heart',
                'title' => 'Valores',
                'description' => 'Verdade, integridade jornalística, respeito pela diversidade e compromisso com a educação islâmica de qualidade acessível a todos.'
            ],
            [
                'icon' => 'globe',
                'title' => 'Visão',
                'description' => 'Ser a principal referência em conteúdo islâmico de qualidade em língua portuguesa, conectando muçulmanos de Moçambique, Brasil, Portugal e todos os PALOP.'
            ],
        ];
    @endphp
